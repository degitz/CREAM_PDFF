%% test_ChenAndMathews
%%
%% Test fat-water algorithms on (ISMRM Challenge's) data
%%
%% Author: Pierre Daude
...
algoParams=ReadYaml('../CREAM_PDFF/algoParams/GOOSE_algoParams.yml');
...
save('output_GOOSE_simu.mat','params','sse'); 